...
const RecipeDetailPage: React.FC = () => {
    ...
    return (
        <div className="space-y-8">
            ...
            <div id="recipe-content-wrapper" ref={recipeContentRef} className="bg-light-card dark:bg-dark-card rounded-lg shadow-lg overflow-hidden">
                     ...
                     <div className="flex flex-col md:flex-row justify-between md:items-start gap-4">
                         ...
                         <div className="flex items-center gap-2 flex-shrink-0">
                            ...
                            <div className="relative">
                                ...
                                {isShareMenuOpen && (
                                     <div className="absolute right-0 mt-2 w-48 bg-light-card dark:bg-dark-card rounded-md shadow-lg z-10 border border-light-border dark:border-dark-border">
